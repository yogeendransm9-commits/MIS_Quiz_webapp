...
export default function LandingPage() {
  ...
  useEffect(() => {
    // Detect environment origin & configure network join URL
    const host = window.location.host;
    const protocol = window.location.protocol;
    
    // Construct base URL for network/local access
    ...
    // Fetch initial participant headcount
    fetchParticipants();

    // Subscribe to realtime participant count updates
